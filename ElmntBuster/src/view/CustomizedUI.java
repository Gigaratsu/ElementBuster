...
public class CustomizedUI extends BasicButtonUI implements MouseListener {
	...
	public CustomizedUI(Color normalColor, Color hoverColor, Color pressedColor) {
		this(normalColor, hoverColor, pressedColor, null, Color.BLACK);
	}
	public CustomizedUI(Color normalColor, Color hoverColor, Color pressedColor, Font btnFont, Color btnFontColor) {
	...
	public CustomizedUI(ImageIcon normalIcon, ImageIcon hoverIcon, ImageIcon pressedIcon) {
	this(normalIcon, hoverIcon, pressedIcon, null, Color.BLACK);
	}
	public CustomizedUI(ImageIcon normalIcon, ImageIcon hoverIcon, ImageIcon pressedIcon, Font btnFont, Color btnFontColor) {
